...
async def health_check():
    ...
    status = "healthy" if database_connected and agent_ready else "degraded"
...
async def query_database_stream(request: QueryRequest, user: dict = Depends(get_current_user)):
    """
